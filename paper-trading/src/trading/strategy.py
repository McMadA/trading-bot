...
class EMASMACrossoverStrategy(BaseStrategy):
    ...
    def __init__(self, config: dict):
        ...
        self._ema_period = config.get("ema_period", 10)
        self._sma_period = config.get("sma_period", 20)
...
class RSIStrategy(BaseStrategy):
    ...
    def __init__(self, config: dict):
        ...
        self._rsi_period = config.get("period", 14)
...
def create_strategy(config) -> BaseStrategy:
    ...
    strategy_name = config.get("strategy.active", "ema_sma_crossover")
